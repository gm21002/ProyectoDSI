...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  } elseif (!$proveedorModel->crearProveedor($nombre)) {
    $_SESSION['errores'] = ['El proveedor ya existe o ocurrió un error.'];
  } else {
    header('Location: RegistrarProveedor.php?exito=1&nombre=' . urlencode($nombre));
    exit;
  }
}
?>
...
<head>
  ...
  <title>Registrar Proveedor - NextGen</title>
    ...
    <main class="main-content">
      ...
      <div class="form-wrapper">
        <?php if (isset($_GET['exito'])): ?>
          <div id="toast" class="toast-success">Proveedor «<?= htmlspecialchars($_GET['nombre']) ?>» registrado correctamente.</div>
        <?php endif; ?>
        ...
        <div class="form-container">
          ...
          <form method="POST">
            ...
            <button type="submit"><i class="bi bi-save"></i>&nbsp; Guardar Proveedor</button>
          </form>
        </div>
      </div>
    </main>
