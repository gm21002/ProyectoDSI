  ...
  <nav class="sidebar">
    ...
    <main class="main-content">
      ...
      <section class="content">
        <h4>Consultar Historial de Movimientos</h4>
        <form method="GET" class="row g-3 mb-3">
          ...
          <div class="col-md-2">
            <select name="tipo" class="form-select">
              ...
              <option <?= ($_GET['tipo'] ?? '') == 'Ajuste' ? 'selected' : '' ?>>Ajuste</option>
            </select>
          </div>
          <div class="col-md-2">
        ...
        <?php else: ?>
          <div class="alert alert-warning mt-3">No se encontraron resultados para los filtros seleccionados.</div>
        <?php endif; ?>
      </section>
    </main>
  </div>
